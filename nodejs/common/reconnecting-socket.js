...
// isomorphic baybee
let CustomEvent = global.CustomEvent || class extends Event {
            ...
            rs.ws.addEventListener('message', (msg) => {
                ...
                if (obj.header.response_to) {
                    ...
                    if (promise) {
                        ...
                        console.error("Reponse to unknown message received, perhaps it timed out?", obj);
                    }
                    return;
                }

                rs.dispatchEvent(new CustomEvent(obj.header.type, {
                    detail: obj
                }));
            });
